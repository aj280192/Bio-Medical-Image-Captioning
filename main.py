...
import argparse
import numpy as np
from modules.dynamic import dynamic_flow
from modules.metrics import compute_scores, bert_metrics
...
def parse_agrs():
    ...
    parser.add_argument('--ann_path', type=str, default='D:\\TU Berlin\\Thesis\\Codes\\Master\\data\\annotated_s.json',
                        help='the path to the directory containing the data.')
